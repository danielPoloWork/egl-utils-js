...
export const TRANSFER_ROUTES = {
  ...
  bootstrap: {
    ...
    budget: 50300,
    why:
      '+936 B in 23.3 for F130/F131 grid navigation, against 647 B on the bundled row — the gap is the usual one, a static page fetching whole files. THIRTEEN requests still: this item added no chunk either. Budget unchanged at 50300 B, which still holds with 1193 B to spare — a ceiling that still holds is not re-pinned upward for the sake of the formula. ' +
