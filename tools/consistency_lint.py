...
"""Agent-runnable consistency lint for egl-utils-js (generated by EADOS).
...
CONFIG = {
    ...
    "version_file": "src/main/javascript/it/d4np/utils/version.js",
