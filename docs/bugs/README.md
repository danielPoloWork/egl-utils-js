...
The **source of truth** for defects in `egl-utils-js`. One Markdown file per defect,
...
| [BUG-0003](2026/08/BUG-0003-cross-realm-abort-signal-in-composites.md) | Composites that own a listener fail against a foreign document — a cross-realm `AbortSignal` | medium | confirmed | — |
